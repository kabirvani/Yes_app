    ...
    <form method="POST" id="company_details_form">
        ...
        <div id="boost_confirm_form">
            ...
            <div class="company_details_dialog download_invoice">
                <div class="title">
                    <p style="text-align:left;color:#c3d836">Download Invoice</p>
                </div>
                <div class="yellow_line" style="background-color:#c3d836"></div>
                <div class="content">
                    ...
                    <div class="btn btn-primary pink" style="width:160px;background-color:#c3d836">
                        DOWNLOAD INVOICE
                    </div>
                </div>
            </div>

            <div class="payment_alert green">
