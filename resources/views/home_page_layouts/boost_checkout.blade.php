    ...
    <form method="POST" id="company_details_form">
        ...
        <div id="boost_confirm_form">
            ...
            <div class="company_details_dialog download_invoice">
                <div class="title">
                    <p style="text-align:left;color:#f15b67">Download Invoice</p>
                </div>
                <div class="yellow_line" style="background-color:#f15b67"></div>
                <div class="content">
                    ...
                    <div class="btn btn-primary pink" style="width:160px;">
                        DOWNLOAD INVOICE
                    </div>
                </div>
            </div>
