...
<div id="company_details" style="padding-top: 84px;">
    <form method="POST" action="{{route('show.boost_checkout')}}" id="company_details_form">
        {{ csrf_field() }}
        ...
        <div id="boost_confirm_form">
            ...
            <p>Enter the number of Yes Youth that you would like to place into a verified host business </p>
            <div class="host">
                <div class="label pink">BOOST A BUSINESS</div>
                <div class="boost_confirm">
                    <div class="youth">
                        <input class="text_num pink" id="youth" placeholder="0" type="text">
            ...
            <div class="btn btn-primary next pink">
                <small>CONFIRM</small>
