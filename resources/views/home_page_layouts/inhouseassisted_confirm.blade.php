...
<div id="company_details" style="padding-top: 84px;">
    <form method="POST" action="{{route('show.inhouseassisted_checkout')}}" id="company_details_form">
        {{ csrf_field() }}
        ...
        <div id="boost_confirm_form">
            <label>How many Youth would you like assistance placing?</label>
            <p>Enter the number of Yes Youth that you would like to place into your oprganisation or supply chain</p>
            <div class="host">
                <div class="label blue">IN-HOUSE ASSISTED</div>
                <div class="boost_confirm">
                    <div class="youth">
                        <input class="text_num blue" id="youth" placeholder="0" type="text">
            ...
            <div class="btn btn-primary next blue">
                <small>CONFIRM</small>
